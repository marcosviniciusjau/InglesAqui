...
<br><br><br>
    ...
    <div class="container col-xxl-8 px-4 py-5" id="contato">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
         <div class="col-10 col-sm-8 col-lg-6">
            ...
            <br>
            <div class="thumbnail"><a href="https://api.whatsapp.com/send?phone=554299098901"><img src="View/Imagens/fale/redes3.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy"></a></div>
            <br>
